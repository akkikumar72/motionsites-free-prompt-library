...
```
Prompt: Recreate "liro.prompt Certificates" Email-Style Landing Page
Build a single-page React + TypeScript + Vite + Tailwind CSS project that renders an email-style marketing page for a "liro.prompt Certificates" AI leadership course, built in collaboration with Microsoft. Use lucide-react for icons. No other UI libraries.
...
"liro.prompt" — Instrument Serif, text-[28px] leading-[0.95] tracking-tight
...
Wordmark link text-[30px] font-bold tracking-tight text-white hover:text-[#DCFF00] transition-colors → "liro.prompt" (wrapped in pb-8 flex justify-center)
...
liro.prompt generally or other liro.prompt products.
...
If you no longer want to receive updates on liro.prompt Certificates,
...
©2026 liro.prompt, 660 4th Street #443, San Francisco, CA 94107 USA
