...
- Prompt ID: `akor-security-landing`
- Title: AKOR Security
...
```
Build Prompt: AKOR Security

Create a premium AI landing page inspired by the public liro.prompt preview for "AKOR Security". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Core direction
Build a polished, production-grade single-page website for cybersecurity and data protection. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Visual system
- Brand name: AKOR Security
- Palette: midnight navy, black glass, signal green, icy blue, high-contrast white
- Scene/backdrop: encrypted nodes, shield geometry, scanning beams, secure command dashboards
...
Copy
- H1: "Secure every layer with AKOR Security"
- Subheading: "A premium security hero with enterprise credibility, motion-led proof points, and calm technical confidence."
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "AKOR Security", center nav links, right CTA button. On mobile collapse into a compact menu button.
