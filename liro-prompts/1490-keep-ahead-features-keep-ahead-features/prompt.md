...
- Prompt ID: `keep-ahead-features`
- Title: Keep Ahead Features
...
```
Build Prompt: Keep Ahead Features

Create a premium AI website hero section inspired by the public liro.prompt preview for "Keep Ahead Features". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Core direction
Build a polished, production-grade hero experience for Features Section. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Visual system
- Brand name: Keep Ahead Features
...
Copy
- H1: "Keep Ahead Features with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Keep Ahead Features", center nav links, right CTA button. On mobile collapse into a compact menu button.
