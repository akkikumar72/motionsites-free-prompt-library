...
- Prompt ID: `nexacore-process`
- Title: NexaCore Process
- Category: Process
- Type: features
- Types: 
- Page type: hero
...
- Video: https://stream.mux.com/TZeoU5M02PPkOIpn01v4z8StDxwvq74wN6nYM5N6oUyVQ.m3u8
...
```
Build Prompt: NexaCore Process

Create a premium AI website hero section inspired by the public liro.prompt preview for "NexaCore Process". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: nexacore-process
- Category: Process
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/TZeoU5M02PPkOIpn01v4z8StDxwvq74wN6nYM5N6oUyVQ.m3u8

Core direction
Build a polished, production-grade hero experience for Process. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "NexaCore Process with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "NexaCore Process", center nav links, right CTA button. On mobile collapse into a compact menu button.
