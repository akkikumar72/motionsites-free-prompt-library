...
```
Build Prompt: Sync AI

Create a premium AI website hero section inspired by the public liro.prompt preview for "Sync AI". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "Sync AI takes the future beyond orbit"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Sync AI", center nav links, right CTA button. On mobile collapse into a compact menu button.
