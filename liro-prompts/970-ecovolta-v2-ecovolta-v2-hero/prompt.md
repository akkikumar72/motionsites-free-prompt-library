...
```
Build Prompt: EcoVolta V2

Create a premium AI website hero section inspired by the public liro.prompt preview for "EcoVolta V2". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "Power the next era with EcoVolta"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "EcoVolta", center nav links, right CTA button. On mobile collapse into a compact menu button.
