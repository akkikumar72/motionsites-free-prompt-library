...
- Prompt ID: `saas-pricing-flow`
- Title: SaaS Pricing Flow
- Category: Pricing
- Type: hero
- Types: 
- Page type: hero
...
- Video: https://stream.mux.com/M3OFzqYDiRkLqi0201Y6i3fJFxF8GQ0000PSf2amO02BQzHY.m3u8
...
```
Build Prompt: SaaS Pricing Flow

Create a premium AI website hero section inspired by the public liro.prompt preview for "SaaS Pricing Flow". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: saas-pricing-flow
- Category: Pricing
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/M3OFzqYDiRkLqi0201Y6i3fJFxF8GQ0000PSf2amO02BQzHY.m3u8

Core direction
Build a polished, production-grade hero experience for Pricing. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Pricing Flow with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Pricing Flow", center nav links, right CTA button. On mobile collapse into a compact menu button.
