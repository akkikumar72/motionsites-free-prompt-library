...
```
Build Prompt: Orbit Web3

Create a premium AI website hero section inspired by the public liro.prompt preview for "Orbit Web3". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "Orbit Web3 for the next financial internet"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Orbit Web3", center nav links, right CTA button. On mobile collapse into a compact menu button.
