...
- Prompt ID: `cybersecurity-hero-v2`
- Title: Cybersecurity Hero v2
- Category: Hero
- Type: hero
- Types: 
- Page type: hero
...
- Video: https://stream.mux.com/EGZKHfCExbpcjrlFHe4fiPcNqOdMQR5hp2RCwYt6n9U.m3u8
...
```
Build Prompt: Cybersecurity Hero v2

Create a premium AI website hero section inspired by the public liro.prompt preview for "Cybersecurity Hero v2". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: cybersecurity-hero-v2
- Category: Hero
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/EGZKHfCExbpcjrlFHe4fiPcNqOdMQR5hp2RCwYt6n9U.m3u8

Core direction
Build a polished, production-grade hero experience for cybersecurity and data protection. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Secure every layer with Cybersecurity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Cybersecurity", center nav links, right CTA button. On mobile collapse into a compact menu button.
