...
```
Build Prompt: Guardnet

Create a premium AI landing page inspired by the public liro.prompt preview for "Guardnet". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "Secure every layer with Guardnet"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Guardnet", center nav links, right CTA button. On mobile collapse into a compact menu button.
