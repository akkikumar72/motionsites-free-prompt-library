...
```
Build Prompt: New Era Bold Hero

Create a premium AI website hero section inspired by the public liro.prompt preview for "New Era Bold Hero". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "New Era Bold creates work people remember"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "New Era Bold", center nav links, right CTA button. On mobile collapse into a compact menu button.
