...
Create a premium AI website hero section inspired by the public liro.prompt preview for "Nexar". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "Nexar with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Nexar", center nav links, right CTA button. On mobile collapse into a compact menu button.
