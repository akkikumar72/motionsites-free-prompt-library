...
Create a premium AI website hero section inspired by the public MotionSites preview for "HR SaaS Hero". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Core direction
Build a polished, production-grade hero experience for SaaS. The design should feel like a premium AI website prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
