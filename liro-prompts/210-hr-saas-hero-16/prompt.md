...
```
Build Prompt: HR SaaS Hero

Create a premium AI website hero section inspired by the public liro.prompt preview for "HR SaaS Hero". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Core direction
Build a polished, production-grade hero experience for SaaS. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "HR with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "HR", center nav links, right CTA button. On mobile collapse into a compact menu button.
