...
```
Build Prompt: Terra Geo Map

Create a premium AI website hero section inspired by the public liro.prompt preview for "Terra Geo Map". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Core direction
Build a polished, production-grade hero experience for mapping, logistics, and infrastructure intelligence. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Visual system
- Brand name: Terra Geo Map
- Palette: dark slate, terrain green, amber routes, clean white, steel blue
- Scene/backdrop: geospatial grids, animated route lines, terrain layers, operational dashboards
...
Copy
- H1: "Terra Geo Map maps decisions in real time"
- Subheading: "A data-rich landing page with map motion, operational cards, and enterprise-grade clarity."
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Terra Geo Map", center nav links, right CTA button. On mobile collapse into a compact menu button.
