...
- Prompt ID: `luxury-editorial-ecommerce-design`
...
- Video: https://stream.mux.com/1tb5PLrFcCkmoBqvflyFoYir9gXKn9njA0002dKgM5hLg.m3u8
...
```
Build Prompt: Luxury Ecommerce Design

Create a premium AI website hero section inspired by the public liro.prompt preview for "Luxury Ecommerce Design". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: luxury-editorial-ecommerce-design
- Category: Ecommerce
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/1tb5PLrFcCkmoBqvflyFoYir9gXKn9njA0002dKgM5hLg.m3u8

Core direction
Build a polished, production-grade hero experience for climate technology and renewable energy. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Power the next era with Luxury Ecommerce"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Luxury Ecommerce", center nav links, right CTA button. On mobile collapse into a compact menu button.
