...
- Prompt ID: `solace-sign-in`
- Title: Solace sign-in
...
- Video: https://stream.mux.com/hfgx8AtzCEX01tAvDZi6vijW2eS019007Y53laKVk81VzU.m3u8
...
```
Build Prompt: Solace sign-in

Create a premium AI website hero section inspired by the public liro.prompt preview for "Solace sign-in". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: solace-sign-in
- Category: Sign In Form
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/hfgx8AtzCEX01tAvDZi6vijW2eS019007Y53laKVk81VzU.m3u8

Core direction
Build a polished, production-grade hero experience for Sign In Form. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Solace sign-in with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Solace sign-in", center nav links, right CTA button. On mobile collapse into a compact menu button.
