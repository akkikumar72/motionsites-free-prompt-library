...
```
Build Prompt: Web3 EOS Hero

Create a premium AI website hero section inspired by the public liro.prompt preview for "Web3 EOS Hero". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "Web3 EOS for the next financial internet"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Web3 EOS", center nav links, right CTA button. On mobile collapse into a compact menu button.
