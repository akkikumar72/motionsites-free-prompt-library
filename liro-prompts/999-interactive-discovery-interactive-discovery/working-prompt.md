# Working Prompt: Interactive Discovery

This is the original full prompt returned by the MotionSites `get-prompt` endpoint in the captured session.

## Metadata

- Prompt ID: `interactive-discovery`
- Category: Hero
- Page type: hero
- Source status: fetched
- Preview video: https://stream.mux.com/Neh02MwL00t9WWvvBAVV3Tgs43edE9kTsycNhC29aWz4Y.m3u8
- Preview image: 
