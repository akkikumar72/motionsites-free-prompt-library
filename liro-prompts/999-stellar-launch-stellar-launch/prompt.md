...
- Video: https://stream.mux.com/colrEaZg99fRXdz00ipw8IV01PLBPPtRSSl413Ec8ABO4.m3u8
...
```
Build Prompt: Stellar Launch

Create a premium AI landing page inspired by the public liro.prompt preview for "Stellar Launch". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: stellar-launch
- Category: Landing Page
- Page type: landing
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/colrEaZg99fRXdz00ipw8IV01PLBPPtRSSl413Ec8ABO4.m3u8

Core direction
Build a polished, production-grade single-page website for space technology and future exploration. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Stellar Launch takes the future beyond orbit"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Stellar Launch", center nav links, right CTA button. On mobile collapse into a compact menu button.
