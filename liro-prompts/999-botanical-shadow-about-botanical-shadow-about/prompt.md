...
- Prompt ID: `botanical-shadow-about`
- Title: Botanical Shadow About
- Category: About
- Type: about
- Types: 
- Page type: hero
...
- Video: https://stream.mux.com/Mkxpw3It0201x7xY6iuhx7o7Yz2f028rYlbDOnxa0202kQcM.m3u8
...
```
Build Prompt: Botanical Shadow About

Create a premium AI website hero section inspired by the public liro.prompt preview for "Botanical Shadow About". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: botanical-shadow-about
- Category: About
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/Mkxpw3It0201x7xY6iuhx7o7Yz2f028rYlbDOnxa0202kQcM.m3u8

Core direction
Build a polished, production-grade hero experience for luxury commerce and premium lifestyle. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Visual system
- Brand name: Botanical Shadow About
...
Copy
- H1: "Botanical Shadow About built for a more refined customer"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Botanical Shadow About", center nav links, right CTA button. On mobile collapse into a compact menu button.
