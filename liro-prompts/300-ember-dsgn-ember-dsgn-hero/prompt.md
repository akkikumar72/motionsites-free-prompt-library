...
```
Build Prompt: EMBER.dsgn

Create a premium AI website hero section inspired by the public liro.prompt preview for "EMBER.dsgn". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "EMBER.dsgn with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "EMBER.dsgn", center nav links, right CTA button. On mobile collapse into a compact menu button.
