...
- Prompt ID: `launchex-submissions`
- Title: LaunchEx Submissions
- Category: Features
- Type: features
- Types: 
- Page type: hero
...
- Video: https://stream.mux.com/m8zP8lIqA4cCWuecz800MQGSoJZhAIw7Zk9Yt2s6d00Ic.m3u8
...
```
Build Prompt: LaunchEx Submissions

Create a premium AI website hero section inspired by the public liro.prompt preview for "LaunchEx Submissions". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: launchex-submissions
- Category: Features
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/m8zP8lIqA4cCWuecz800MQGSoJZhAIw7Zk9Yt2s6d00Ic.m3u8

Core direction
Build a polished, production-grade hero experience for Features. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Visual system
- Brand name: LaunchEx Submissions
...
Copy
- H1: "LaunchEx Submissions with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "LaunchEx Submissions", center nav links, right CTA button. On mobile collapse into a compact menu button.
