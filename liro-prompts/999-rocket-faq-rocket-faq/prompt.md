...
- Video: https://stream.mux.com/3st3sdTlYF9eOIkj8RPSTc4pfUH9wMnHDAQTUXiENKs.m3u8
...
```
Build Prompt: Rocket FAQ

Create a premium AI website hero section inspired by the public liro.prompt preview for "Rocket FAQ". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: rocket-faq
- Category: FAQ
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/3st3sdTlYF9eOIkj8RPSTc4pfUH9wMnHDAQTUXiENKs.m3u8

Core direction
Build a polished, production-grade hero experience for FAQ. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Rocket FAQ with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Rocket FAQ", center nav links, right CTA button. On mobile collapse into a compact menu button.
