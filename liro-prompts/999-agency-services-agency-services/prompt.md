...
- Video: https://stream.mux.com/5D1X6OFP9m8JcEiRIlgbBaBUrlFG98lgzE9if99g9tg.m3u8
...
```
Build Prompt: Agency Services

Create a premium AI website hero section inspired by the public liro.prompt preview for "Agency Services". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: agency-services
- Category: Services
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/5D1X6OFP9m8JcEiRIlgbBaBUrlFG98lgzE9if99g9tg.m3u8

Core direction
Build a polished, production-grade hero experience for creative studio, agency, and portfolio. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Agency Services creates work people remember"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Agency Services", center nav links, right CTA button. On mobile collapse into a compact menu button.
