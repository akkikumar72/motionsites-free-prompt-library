...
- Prompt ID: `veloce-finance-landing`
- Title: Veloce Finance
...
```
Build Prompt: Veloce Finance

Create a premium AI landing page inspired by the public liro.prompt preview for "Veloce Finance". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Core direction
Build a polished, production-grade single-page website for fintech, payments, and financial operations. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Veloce Finance makes money movement feel effortless"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Veloce Finance", center nav links, right CTA button. On mobile collapse into a compact menu button.
