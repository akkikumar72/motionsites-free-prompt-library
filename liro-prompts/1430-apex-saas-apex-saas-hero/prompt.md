...
```
Build Prompt: Apex SaaS

Create a premium AI website hero section inspired by the public liro.prompt preview for "Apex SaaS". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "Apex makes money movement feel effortless"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Apex", center nav links, right CTA button. On mobile collapse into a compact menu button.
