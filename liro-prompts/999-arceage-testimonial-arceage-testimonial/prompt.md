...
- Prompt ID: `arceage-testimonial`
- Title: Arceage Testimonial
...
- Video: https://stream.mux.com/PHDFVXZBtSFWVqfrsKvKpatUj9yUseRws02tI0143G7zU.m3u8
...
```
Build Prompt: Arceage Testimonial

Create a premium AI website hero section inspired by the public liro.prompt preview for "Arceage Testimonial". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: arceage-testimonial
- Category: Testimonials
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/PHDFVXZBtSFWVqfrsKvKpatUj9yUseRws02tI0143G7zU.m3u8

Core direction
Build a polished, production-grade hero experience for Testimonials. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Visual system
- Brand name: Arceage Testimonial
...
Copy
- H1: "Arceage Testimonial with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Arceage Testimonial", center nav links, right CTA button. On mobile collapse into a compact menu button.
