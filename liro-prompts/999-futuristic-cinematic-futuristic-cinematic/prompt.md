...
- Prompt ID: `futuristic-cinematic`
- Title: Futuristic Cinematic
- Category: Hero
- Type: hero
- Types: 
- Page type: hero
...
- Video: https://stream.mux.com/TzDBHDPqamrkQ00900jiCGdpwiXhbA6NtUR4vGX52Xdpk.m3u8
...
```
Build Prompt: Futuristic Cinematic

Create a premium AI website hero section inspired by the public liro.prompt preview for "Futuristic Cinematic". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: futuristic-cinematic
- Category: Hero
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/TzDBHDPqamrkQ00900jiCGdpwiXhbA6NtUR4vGX52Xdpk.m3u8

Core direction
Build a polished, production-grade hero experience for Hero. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Visual system
- Brand name: Futuristic Cinematic
...
Copy
- H1: "Futuristic Cinematic with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Futuristic Cinematic", center nav links, right CTA button. On mobile collapse into a compact menu button.
