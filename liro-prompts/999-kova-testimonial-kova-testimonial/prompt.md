...
- Prompt ID: `kova-testimonial`
- Title: Kova Testimonial
...
- Video: https://stream.mux.com/uajH9024siIXzKHAW8EIuFDhR1EfiqFGQeTnhaTVSDAE.m3u8
...
```
Build Prompt: Kova Testimonial

Create a premium AI website hero section inspired by the public liro.prompt preview for "Kova Testimonial". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: kova-testimonial
- Category: Testimonial
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/uajH9024siIXzKHAW8EIuFDhR1EfiqFGQeTnhaTVSDAE.m3u8

Core direction
Build a polished, production-grade hero experience for Testimonial. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Kova Testimonial with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Kova Testimonial", center nav links, right CTA button. On mobile collapse into a compact menu button.
