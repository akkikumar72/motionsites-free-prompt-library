...
- Video: https://stream.mux.com/hAWGJKD00eq8u02KX00021VEBQpi01GEV01QETwhyikhIR00Ig.m3u8
...
```
Build Prompt: Kova Features

Create a premium AI website hero section inspired by the public liro.prompt preview for "Kova Features". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: kova-features
- Category: Benefits
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/hAWGJKD00eq8u02KX00021VEBQpi01GEV01QETwhyikhIR00Ig.m3u8

Core direction
Build a polished, production-grade hero experience for Benefits. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Kova Features with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Kova Features", center nav links, right CTA button. On mobile collapse into a compact menu button.
