...
- Video: https://stream.mux.com/oJXsdIPdtGOIOGWG02kxQcrasVJ1vJtoGqNdb601kwn9o.m3u8
...
```
Build Prompt: Projects Catalog

Create a premium AI website hero section inspired by the public liro.prompt preview for "Projects Catalog". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: projects-catalog
- Category: Projects
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/oJXsdIPdtGOIOGWG02kxQcrasVJ1vJtoGqNdb601kwn9o.m3u8

Core direction
Build a polished, production-grade hero experience for Projects. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Projects Catalog with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Projects Catalog", center nav links, right CTA button. On mobile collapse into a compact menu button.
