...
- Prompt ID: `glassmorphic-feature-tabs`
- Title: Glassmorphic Feature Tabs
- Category: Tabs
- Type: features
- Types: 
- Page type: hero
...
- Video: https://stream.mux.com/A01IZO00AKvw5azFRte61GufV00g003vyoS00t5Fm24xfvnA.m3u8
...
```
Build Prompt: Glassmorphic Feature Tabs

Create a premium AI website hero section inspired by the public liro.prompt preview for "Glassmorphic Feature Tabs". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: glassmorphic-feature-tabs
- Category: Tabs
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/A01IZO00AKvw5azFRte61GufV00g003vyoS00t5Fm24xfvnA.m3u8

Core direction
Build a polished, production-grade hero experience for Tabs. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Visual system
- Brand name: Glassmorphic Feature Tabs
...
Copy
- H1: "Glassmorphic Feature Tabs with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Glassmorphic Feature Tabs", center nav links, right CTA button. On mobile collapse into a compact menu button.
