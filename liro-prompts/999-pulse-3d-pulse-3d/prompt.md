...
- Video: https://stream.mux.com/8nPqkRyCqB5VW8Be3BW2Xe4d1J3SLT5OVjwjq4Q00SMY.m3u8
...
```
Build Prompt: Pulse 3D

Create a premium AI landing page inspired by the public liro.prompt preview for "Pulse 3D". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: pulse-3d
- Category: 3D Website
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/8nPqkRyCqB5VW8Be3BW2Xe4d1J3SLT5OVjwjq4Q00SMY.m3u8

Core direction
Build a polished, production-grade single-page website for 3D Website. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
- Scene/backdrop: cinematic abstract background, floating interface panels, strong editorial typography
...
Copy
- H1: "Pulse 3D with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Pulse 3D", center nav links, right CTA button. On mobile collapse into a compact menu button.
