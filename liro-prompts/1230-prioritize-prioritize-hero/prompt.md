...
```
Build Prompt: Prioritize

Create a premium AI website hero section inspired by the public liro.prompt preview for "Prioritize". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "Prioritize with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Prioritize", center nav links, right CTA button. On mobile collapse into a compact menu button.
