...
```
Build Prompt: Impressive Hero

Create a premium AI website hero section inspired by the public liro.prompt preview for "Impressive Hero". This is a reconstruction from public metadata and preview media, not the original paid prompt text.
...
Copy
- H1: "Impressive with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Impressive", center nav links, right CTA button. On mobile collapse into a compact menu button.
