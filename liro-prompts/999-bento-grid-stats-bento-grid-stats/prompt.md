...
- Video: https://stream.mux.com/xGvDZxzLVit4lRXWuLfZS01CIdMLjeD4QJ5nb3nooTYY.m3u8
...
```
Build Prompt: Bento Grid Stats

Create a premium AI website hero section inspired by the public liro.prompt preview for "Bento Grid Stats". This is a reconstruction from public metadata and preview media, not the original paid prompt text.

Reference input
- Prompt ID: bento-grid-stats
- Category: Bento
- Page type: hero
- Visual reference: Use the public preview video as the primary visual reference and, when building a browser prototype, as the full-bleed hero background: https://stream.mux.com/xGvDZxzLVit4lRXWuLfZS01CIdMLjeD4QJ5nb3nooTYY.m3u8

Core direction
Build a polished, production-grade hero experience for Bento. The design should feel like a premium liro.prompt prompt: cinematic composition, large confident typography, high contrast, strong negative space, glassy interface surfaces, careful micro-interactions, and an immediate first-viewport brand signal.
...
Copy
- H1: "Bento Grid Stats with premium motion and clarity"
...
Component details
- Navbar: transparent/glass container, left-aligned wordmark "Bento Grid Stats", center nav links, right CTA button. On mobile collapse into a compact menu button.
